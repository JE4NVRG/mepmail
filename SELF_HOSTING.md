...
credential (a JWT, 32 or more hex characters, 40 or more of base64) is
masked, as is a 4-to-8-digit run within 40 characters of a word like *code*,
*código*, *OTP*, *PIN*, *token*, *senha*, *password* or *verification*.

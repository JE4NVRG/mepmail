...
description: Como planos, Stripe Checkout e o webhook se encaixam em uma implantação hospedada do MepMail, e como provisionar uma conta Stripe para ela.
---
...
- **Configuração do portal** é localizada por metadata e tem as
  ...
  empresa (`mepmail.agenciamep.com/terms`, `/privacy`) e, com `--app-url`, a URL de
  retorno.

---
title: CLI
description: "@millionsend/cli — mova uma conta de e-mail para o MepMail pelo terminal: plan, apply, status, rollback."
---
...
| `--to-url <url>` | URL da API de uma instância auto-hospedada do MepMail. Sem ela, o destino é o MepMail Cloud (`https://api-mepmail.agenciamep.com`), como nos SDKs. |
...
export MILLIONSEND_BASE_URL=https://api-mepmail.agenciamep.com   # ou a URL da sua instância

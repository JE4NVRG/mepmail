...
```sh
mkdir millionsend && cd millionsend
curl -O https://raw.githubusercontent.com/JE4NVRG/mepmail/main/deploy/docker-compose.yml
curl -o .env https://raw.githubusercontent.com/JE4NVRG/mepmail/main/.env.example
```
...
```sh
git clone https://github.com/JE4NVRG/mepmail.git
cd millionsend

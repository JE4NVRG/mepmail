---
title: Introdução
description: O que é o MepMail e como as peças se encaixam.
---
...
- **MepMail Cloud** — o serviço hospedado em
  [mepmail.agenciamep.com](https://mepmail.agenciamep.com). Cadastre-se, verifique um
  domínio, envie. API em `api-mepmail.agenciamep.com`.
...
A plataforma é [AGPL-3.0](https://github.com/JE4NVRG/millionsend/blob/main/LICENSE).

...
description: How plans, Stripe Checkout, and the webhook fit together on a hosted MepMail deployment, and how to provision a Stripe account for it.
---
...
- **Portal configuration** is found by metadata and its settings refreshed:
  ...
  profile's terms and privacy links (`mepmail.agenciamep.com/terms`, `/privacy`)

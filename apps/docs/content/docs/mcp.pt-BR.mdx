---
title: Servidor MCP
description: Conecte agentes de IA ao MepMail pelo Model Context Protocol.
---
...
Auto-hospedado: troque `https://api-mepmail.agenciamep.com/mcp` pela URL do servidor

---
title: Introduction
description: What MepMail is and how the pieces fit together.
---
...
- **MepMail Cloud** — the hosted service at
  [mepmail.agenciamep.com](https://mepmail.agenciamep.com). Sign up, verify a domain, send.
  API at `api-mepmail.agenciamep.com`.
...
The platform is [AGPL-3.0](https://github.com/JE4NVRG/millionsend/blob/main/LICENSE).

---
title: CLI
description: "@millionsend/cli — move an email account to MepMail from your terminal: plan, apply, status, rollback."
---
...
| `--to-url <url>` | API URL of a self-hosted MepMail instance. Unset, the target is MepMail Cloud (`https://api-mepmail.agenciamep.com`), like the SDKs. |
...
export MILLIONSEND_BASE_URL=https://api-mepmail.agenciamep.com   # or your instance's URL

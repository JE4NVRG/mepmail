---
title: MCP server
description: Connect AI agents to MepMail through the Model Context Protocol.
---
...
`https://api-mepmail.agenciamep.com/mcp`
...
```sh
claude mcp add --transport http mepmail https://api-mepmail.agenciamep.com/mcp
```
...
```json title="claude_desktop_config.json"
{
  "mcpServers": {
    "mepmail": {
      "command": "npx",
      "args": ["-y", "mcp-remote@0.8.2", "https://api-mepmail.agenciamep.com/mcp"]
    }
  }
}
```
...
```json title=".cursor/mcp.json"
{
  "mcpServers": {
    "mepmail": {
      "url": "https://api-mepmail.agenciamep.com/mcp"
    }
  }
}
```
...
Self-hosted: replace `https://api-mepmail.agenciamep.com/mcp` with your instance's

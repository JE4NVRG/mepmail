...
Ou aponte o agente para ele: `https://github.com/JE4NVRG/millionsend/blob/main/apps/docs/content/prompts/migrate-from-resend.pt-BR.md`.
...
## 2. Aponte seu código existente para o MepMail
...
const resend = new Resend("ms_...", { baseUrl: "https://api-mepmail.agenciamep.com" });
```
